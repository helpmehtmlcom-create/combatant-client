...
public enum DeferredResource {
    ...
    INDIRECT_LIGHT(FrameGraphResourceKey.transientTexture("world.indirect_light"),
            DeferredTextureSpec.compute(GpuFormat.RG11B10_FLOAT, DeferredTextureSpec.ResolutionClass.INDIRECT_LIGHT, false)),
    LIGHTING_COLOR(FrameGraphResourceKey.transientTexture("world.lighting_color"),
            DeferredTextureSpec.computeAttachment(GpuFormat.RG11B10_FLOAT, DeferredTextureSpec.ResolutionClass.FULL)),
