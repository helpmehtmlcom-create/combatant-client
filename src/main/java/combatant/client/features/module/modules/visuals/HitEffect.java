...
@ModuleInfo(id = "hiteffect", displayName = "HitEffect", category = ModuleCategory.VISUALS, description = "Spawns customizable visual effects and shockwaves on attacked entities.")
