...
@ModuleInfo(id = "soundesp", displayName = "SoundESP", category = ModuleCategory.VISUALS, description = "Renders 3D markers and directional indicators at the origin of world sounds and footstep audio.")
