...
@ModuleInfo(id = "scaffold", displayName = "Scaffold", aliases = {"bridge", "autobridge"}, category = ModuleCategory.PLAYER, description = "Automatically bridges and places blocks beneath your feet as you walk, sprint, or jump.")
